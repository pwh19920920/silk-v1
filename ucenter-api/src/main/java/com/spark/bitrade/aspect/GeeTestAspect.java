...
//
//    @Pointcut("execution(public * com.spark.bitrade.controller.SmsController.sendCheckCode(..))" +
//            "||execution(public * com.spark.bitrade.controller.RegisterController.sendRegEmailCheckCode(..))" + //邮件注册验证码
//            "||execution(public * com.spark.bitrade.controller.RegisterController.registerByEmail(..))" +       //激活方式注册
//            "||execution(public * com.spark.bitrade.controller.SmsController.resetPasswordCode(..))" +
//            "||execution(public * com.spark.bitrade.controller.RegisterController.sendResetPasswordCode(..))")
//    public void geeTest() {
//    }
//
//    @Before("geeTest()")
...
//            ip = "127.0.0.1"; //随便给定一个ip（貌似没有实际意义）
//        }
...
//     *  
//     */
//    @AfterThrowing(pointcut = "geeTest()")
