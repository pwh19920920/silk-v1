...
public class ApplicationConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new MemberInterceptor())
                .addPathPatterns("/**")
                .excludePathPatterns(
                        "/hqb/yesterdayThousandsIncome","/hqb/lastMonthThousandsIncome",
                        "/v2/api-docs", "/configuration/ui", "/swagger-resources", "/configuration/security", "/swagger-ui.html", "/webjars/**",
                        "/lock/lockActivitySetting/**","/lock/reward/redo", "/lock/ieoActivitySetting",
                        "/healthy","/systemTime","/goldenKey/goldenKeySetting","/lock/ieoBccActivitySetting",
                        "/bccEnergize/bccEnergizeActivitySetting","/LockActivt/lockActivtList","/redPack/findValidRedPack",
                        "/redPack/unpack","/redPack/findRedpackRecord");
