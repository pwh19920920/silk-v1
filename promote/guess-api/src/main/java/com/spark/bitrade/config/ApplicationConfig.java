...
public class ApplicationConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new MemberInterceptor())
                .addPathPatterns("/**")
                .excludePathPatterns("/guessActivity/pageOnePeriodBettingRecord",
                        "/guessCoin/getGuessCoin","/healthy","/systemTime",
                        "/guessCoin/toRate","/guessActivity/guessConfig", "/guessActivity/priceRange",
                        "/guessActivity/rewardPage", "/guessActivity/pageRecord",
                        "/guessActivity/oneRecord", "/guessActivity/pageRewardByPeriodId",
                        "/guessActivity/check/login" , "/guessActivity/rewardHistory",
                        "/guessActivity/jackpotInstruct");
