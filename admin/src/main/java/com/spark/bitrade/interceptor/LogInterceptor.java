...
public class LogInterceptor implements HandlerInterceptor, AfterReturningAdvice {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        ...
        // >>> add by zyj start
        String beOperatedIdType=request.getParameter("beOperatedIdType")==null?"":request.getParameter("beOperatedIdType");
        String beOperatedId=request.getParameter("beOperatedId")==null?"":request.getParameter("beOperatedId");
//        String beOperatedRemark=(String) request.getAttribute("beOperatedRemark");
        // <<< add by zyj end
        ...
        if (al != null) {
            ...
            //add by zyj 2018-11-08 accesslog表存入备注
            adminAccessLog.setRemark(beOperatedId);
