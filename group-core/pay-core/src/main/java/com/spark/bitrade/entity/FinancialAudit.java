...
public class FinancialAudit {
    ...
    /**
     * 0 未审核，1审核通过，2审核拒绝 默认0
     */
    @ApiModelProperty(value = "0 未审核，1审核通过，2审核拒绝 默认0", example = "")
     ...
     * 运营审核状态默认待审核 0
     */
    @ApiModelProperty(value = "运营审核状态默认待审核 0", example = "")
