...
import com.spark.bitrade.dao.AdminAccessLogDao;
...
public class AdminAccessLogService extends BaseService {
    ...
    /*public Page<AdminAccessLog> findAll(Predicate predicate, Pageable pageable) {
        return adminAccessLogDao.findAll(predicate, pageable);
    }*/
}
