...
/**
 * 金钥匙活动用户账户数据+IEO-BTTC账户数据
 * @author huyu
 * @time 2019/5/8
 */
@Data
@ApiModel(description = "金钥匙活动用户账户数据")
public class LockBttcOfflineWalletAndIeoWWalletVo {
    /**
     * 可用余额
     */
     ...
     * IEO-BTTC金钥匙总数
     */
    @ApiModelProperty(name = "ieoBalance",value = "IEO-BTTC金钥匙总数")
    private BigDecimal ieoBalance;
}
