...
/**
 * (LockBttcRestitutionIncomePlan)实体类
 *
 * @author dengdy
...
@ApiModel()
public class LockBttcRestitutionIncomePlan implements Serializable {
    private static final long serialVersionUID = 849216831700421856L;
