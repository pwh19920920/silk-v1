...
<div class="LHJsection">
    <div class="container">
        <div class="section">
            <div style="color: #999; font-size: 12px">【已取消】</div>
            <div class="payStatus text-center">
            <#--    <span class="status success">SLB支付成功</span>-->

                <span class="status fail" style="width: auto;">SLB支付失败,${result.message}</span>
            ...
            <div class="text-center">
                <#--<P><button type="button" class="btn btn-primary mt-5" style="width: 300px">返回</button></P>-->

                <P><button type="button" class="btn btn-primary mt-5" id="rePay" style="width: 300px">重新支付</button></P>
                <P><button type="button" class="btn btn-link" id="cancel" style="width: 300px">返回</button></P>
