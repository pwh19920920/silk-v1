...
public class OtcController {
    ...
    public MessageRespResult<PageData<PayRecordDto>> flowRecord(String unit, Long memberId, Long appId, Integer pageNo, Integer pageSize,
        ...
        if (coin == null) {
            return MessageRespResult.error(MessageCode.INVALID_OTC_COIN);
        }
        PageInfo<OtcOrderVO> orderPageInfo =
                otcOrderService.findRecordByUidAndAppId(coin.getId(), memberId, appId, pageNo, pageSize, startTime, endTime);
