...
public class ApiApplicationTests {
     ...
     */
    @Test
    public void saveOtcSummarizeRecord() {
        Order order = orderService.findOneByOrderSn("164843327055859712");
        System.out.print(orderService.saveOtcSummarizeRecord(order.getOrderSn(), order.getCommission(), order.getCoin()));
    }
