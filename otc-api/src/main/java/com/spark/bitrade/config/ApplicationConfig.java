...
public class ApplicationConfig extends WebMvcConfigurerAdapter {
    ...
    @Override
    //edit by yangch 时间： 2018.04.29 原因：合并代码
    /*public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new MemberInterceptor())
                .addPathPatterns("/**")
                .excludePathPatterns("/coin/all", "/advertise/excellent", "/advertise/page","/advertise/page-by-unit","/order/pre");
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new MemberInterceptor())
                ...
                .excludePathPatterns("/v2/api-docs", "/configuration/ui", "/swagger-resources", "/configuration/security", "/swagger-ui.html", "/webjars/**",
                        "/coin/config", "/coin/all", "/coin/coinRank","/advertise/page-by-unit","/advertise/advertiseConfig",
                        "/coin/supported","/healthy","/systemTime","/flushCache","/advertise/member","/order/releaseBOAForApi"); //edit by tansitao 时间： 2018/11/02 原因：修改过滤的接口
